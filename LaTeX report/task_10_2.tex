...
\textit{Answer 10.2.1.1} \todo{REMOVE}\\
Since the task were to control the pitch and travel, the elevation was not a part of the system model. The system's state was therefore described by: 
